...
## v0.1 — First usable input path (complete)
...
Checkpoint: `nix build` passes protocol, daemon integration, and real model
decoding tests; a live session emits microphone level events.

## v0.2 — Desktop overlay and measurement
